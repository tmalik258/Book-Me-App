...
class FlightHotelScreen extends StatefulWidget {
  const FlightHotelScreen({super.key});

  @override
  _FlightHotelScreenState createState() => _FlightHotelScreenState();
}

class _FlightHotelScreenState extends State<FlightHotelScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Book a Flight & Hotel'),
  ...
  return Padding(
    ...
    child: TextField(
      decoration: InputDecoration(
        labelText: label,
        labelStyle: TextStyle(color: Colors.blue[300], fontWeight: FontWeight.w500),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(30), // Rounded corners
          borderSide: BorderSide(color: Colors.blue[300]!), // Border color
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(30),
          borderSide: BorderSide(color: Colors.blue[300]!, width: 2), // Emphasize when focused
        ),
...
Widget _buildDateField(String label, DateTime? date) {
  ...
  backgroundColor: Colors.blue[300], // Replace `primary` with `backgroundColor`
